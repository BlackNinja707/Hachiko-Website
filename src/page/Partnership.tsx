...
const Partnerships = forwardRef<HTMLDivElement>((_, ref) => {
    return (
        <div ref={ref} className="bg-[#FEE8E9] text-[#684222] py-10 select-none">
            {/* Header Section */}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 border-[#684222] border-t-[1px] border-l-[1px]">
                {/* Partnership Items */}
            ...
            <div className="grid grid-cols-5 md:grid-cols-5 border-[#684222]  border-t-[1px]">
